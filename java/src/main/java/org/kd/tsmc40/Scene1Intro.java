...
public final class Scene1Intro extends BaseScene2 {
    ...
    public void render(float v) {
        ...
        if (frame < 720) {
            ...
            hugeFont.draw(batch, "40", Gdx.graphics.getWidth() / 2f - 3 * fiftyFontSize / 4f, Gdx.graphics.getHeight() / 2f + fiftyFontSize / 2f);
            ...
            Effects.typewriter(batch, fontSmall, 20, 900, 2100, 80, "On February 21st, 1987", 2);
