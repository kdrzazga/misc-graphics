...
public class Scene1c64 extends BasicC64Screen {
    ...
    public void create() {
        ...
        this.year2016 = new Year2016(this.year2021.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year2011 = new Year2011(this.year2016.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year2006 = new Year2006(this.year2011.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year2001 = new Year2001(this.year2006.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year1996 = new Year1996(this.year2001.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year1991 = new Year1991(this.year1996.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year1986 = new Year1986(this.year1991.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year1981 = new Year1981(this.year1986.getStartingFrame() + Year.DEFAULT_DURATION);
        this.year1976 = new Year1976(this.year1981.getStartingFrame() + Year.DEFAULT_DURATION);
        this.createMusic();
